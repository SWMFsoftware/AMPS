...
Tecplot record to identify its altitude through an altitude column, an
altitude-bearing `ZONE` header, or an explicit zero-based `Shell_0`/`Shell_1`
zone index. It rejects missing and unexpected shells, writes strict single-
shell products, and revalidates their three-state schema with the C10 parser.
