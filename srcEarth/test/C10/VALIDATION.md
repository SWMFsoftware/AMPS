...
## Validation that still must be performed with the archive

The execution environment used to prepare this package did not contain the
NOAA/NCEI December-2006 daily files and did not permit a live archive download
from the Python/container runtime.  Consequently, the package intentionally does
not claim that an archive-derived compressed reference CSV has already been generated.

After downloading the data, perform these checks:
