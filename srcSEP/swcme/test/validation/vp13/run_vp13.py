#!/usr/bin/env python3
"""Run VP13: Controlled one-dimensional and three-dimensional AMPS equivalence."""
...
def main() -> int:
    ...
    return run("VP13",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP13 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
