#!/usr/bin/env python3
"""Run VP11: Connectivity transitions and observed SEP access."""
...
def main() -> int:
    ...
    return run("VP11",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP11 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
