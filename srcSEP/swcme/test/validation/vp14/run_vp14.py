#!/usr/bin/env python3
"""Run VP14: Perpendicular diffusion and multi-spacecraft longitudinal spread."""
...
def main() -> int:
    ...
    return run("VP14",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP14 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
