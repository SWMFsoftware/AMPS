#!/usr/bin/env python3
"""Materialize the immutable VP06 benchmark descriptor.
...
CASE="VP06"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"In-situ Rankine-Hugoniot jumps and flux conservation","fixture_kind":"ANALYTICAL_REFERENCE","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
