#!/usr/bin/env python3
"""Run VP07: Shock normal, obliquity, and acceleration geometry."""
...
def main() -> int:
    ...
    return run("VP07",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP07 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
