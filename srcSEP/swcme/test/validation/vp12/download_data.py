#!/usr/bin/env python3
"""Materialize the immutable VP12 benchmark descriptor.
...
CASE="VP12"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"SEP source records, identity, attribution, and source spectrum","fixture_kind":"COUPLING_BENCHMARK","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
