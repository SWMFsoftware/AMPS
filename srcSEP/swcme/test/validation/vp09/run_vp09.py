#!/usr/bin/env python3
"""Run VP09: Sheath/ejecta classifications and region-boundary timing."""
...
def main() -> int:
    ...
    return run("VP09",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP09 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
