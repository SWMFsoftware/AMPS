...
//-------------------------------------
void PIC::Parallel::copy_plasma_to_buffer(cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node, 
...
void PIC::Parallel::copy_net_charge_to_buffer(cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node, 
					  const int i, const int j, const int k, char *bufferPtr) {
...
void PIC::Parallel::add_plasma_to_node(cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node, 
...
void PIC::Parallel::add_net_charge_to_node(cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node, 
					   const int i, const int j, const int k, 
					   char *bufferPtr, double coef){
