#!/usr/bin/env python3
"""Materialize the immutable VP14 benchmark descriptor.
...
CASE="VP14"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"Perpendicular diffusion and multi-spacecraft longitudinal spread","fixture_kind":"COUPLING_BENCHMARK","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
