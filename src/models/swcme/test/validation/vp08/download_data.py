#!/usr/bin/env python3
"""Materialize the immutable VP08 benchmark descriptor.
...
CASE="VP08"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"Reconstructed 3-D shock front and observer intersections","fixture_kind":"ANALYTICAL_REFERENCE","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
