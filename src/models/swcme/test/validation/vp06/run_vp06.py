#!/usr/bin/env python3
"""Run VP06: In-situ Rankine-Hugoniot jumps and flux conservation."""
...
def main() -> int:
    ...
    return run("VP06",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP06 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
