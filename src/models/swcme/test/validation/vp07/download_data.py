#!/usr/bin/env python3
"""Materialize the immutable VP07 benchmark descriptor.
...
CASE="VP07"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"Shock normal, obliquity, and acceleration geometry","fixture_kind":"ANALYTICAL_REFERENCE","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
