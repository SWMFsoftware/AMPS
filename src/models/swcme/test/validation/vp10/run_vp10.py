#!/usr/bin/env python3
"""Run VP10: Parker mapping, field-line path length, and focusing."""
...
def main() -> int:
    ...
    return run("VP10",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP10 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
