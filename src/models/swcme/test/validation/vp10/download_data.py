#!/usr/bin/env python3
"""Materialize the immutable VP10 benchmark descriptor.
...
CASE="VP10"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"Parker mapping, field-line path length, and focusing","fixture_kind":"ANALYTICAL_REFERENCE","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
