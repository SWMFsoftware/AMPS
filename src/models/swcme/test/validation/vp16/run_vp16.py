#!/usr/bin/env python3
"""Run VP16: Held-out multi-event and cross-model skill assessment."""
...
def main() -> int:
    ...
    return run("VP16",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP16 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
