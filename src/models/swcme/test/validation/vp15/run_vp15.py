#!/usr/bin/env python3
"""Run VP15: SEP onset, profile, spectrum, peak intensity, and fluence."""
...
def main() -> int:
    ...
    return run("VP15",CASE_DIR,args.output_dir,args.no_plots)

if __name__=="__main__":
    try: raise SystemExit(main())
    except Exception as error:
        print(f"VP15 setup/analysis error: {error}",file=sys.stderr)
        raise SystemExit(2)
