#!/usr/bin/env python3
"""Materialize the immutable VP13 benchmark descriptor.
...
CASE="VP13"
PAYLOAD={"schema_version":1,"validation_id":CASE,"title":"Controlled one-dimensional and three-dimensional AMPS equivalence","fixture_kind":"COUPLING_BENCHMARK","source":"case-owned reference_solution.py and public SWCME production API","network_required":False}
def main() -> int:
